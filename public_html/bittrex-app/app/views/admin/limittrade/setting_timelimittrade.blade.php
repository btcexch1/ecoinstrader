...
<form class="form-horizontal" role="form" id="add_limit_trade" method="POST" action="{{{ Confide::checkAction('Admin_SettingController@setLimitTrade') ?: URL::to('/admin/add-time-limit-trade') }}}">	
