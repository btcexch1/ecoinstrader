...
<div id="yourorders">
    ...
    <div class="icon-driver"><i class="icon-arrow-down-5 on-right on-left"></i></div>
</div>
@include('blocks.statistic')
<div class="clear"></div>
@include('blocks.news_tweet')
<!-- <div class="clear"></div> -->
@stop
...
<script>
	...
	$(function(){
		window.socket = {};
		socket = io.connect( 'http://115.78.235.170:8081' );
