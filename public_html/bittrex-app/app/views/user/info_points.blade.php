<!-- Edit Profile -->
<div id="ecoinstrader-points">
  <div class="panel panel-default">
    <div class="panel-heading"> 
      <span class="glyphicon glyphicon-contact-info"></span> {{{ trans('user_texts.ecoinstrader_points') }}}
    </div>
    <div class="generaltext">
        <!-- <br>          
        <strong>Ecoinstrader has committed 5% of our trade revenue to go towards our Ecoinstrader Points reward program</strong>         
        <br><br> -->         

        <h4>What Are Ecoinstrader Points?</h4>
        Ecoinstrader Points are rewards points for doing what you are already doing.  At the end of each day we review your activity from trades and referred users and award you points for that activity.
        <br><br>          

        <h4>What Can I Do With Ecoinstrader Points?</h4>
        Ecoinstrader Points can be traded on the exchange under the "Points/BTC" trading pair.  You can transfer Ecoinstrader Points to other users.  You can also use your Ecoinstrader Points to enter weekly drawings for some pretty awesome prizes.   
        ...
        <br>                  
        <h4>When Do I Get Paid My Ecoinstrader Points?</h4>
        ...
        Each entry will cost 0.1 Ecoinstrader Point.   Users may place up to 100 entries into any single drawing.
        <br><br>
